    ...
    class << self
      def start(instance, agent_client, update_config, is_canary = false, run_post_start = false, logger = Config.logger)
        ...
        if update_config && run_post_start
          ...
          wait_until_desired_state(instance, agent_client, min_watch_time, max_watch_time, logger)
      ...
      def wait_until_desired_state(instance, agent_client, min_watch_time, max_watch_time, logger)
        current_state = {}
